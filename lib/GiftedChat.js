...
class GiftedChat extends React.Component {
    ...
    renderMessages() {
        ...
        return (<AnimatedView style={{
            ...
            <MessageContainer {...this.props} is_landscape={this.props.is_landscape} is_pad={this.props.is_pad} invertibleScrollViewProps={this.invertibleScrollViewProps} messages={this.getMessages()} forwardRef={this._messageContainerRef} />
