...
// const wrapleftcolor = this.props.wrapperStyle.left.backgroundColor
const styles = {
...
export default class Bubble extends React.Component {
    ...
    render() {
        var nextvalue = this.styledBubbleToNext();
        var prevvalue = this.styledBubbleToPrevious();
        // if(nextvalue != null) {
        //     alert(nextvalue)
        // }

        const { position, containerStyle, wrapperStyle, bottomContainerStyle, nextMessage, previousMessage } = this.props;
