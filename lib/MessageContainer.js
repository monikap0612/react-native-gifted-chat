    ...
    render() {
        ...
        return (<View style={this.props.alignTop ? styles.containerAlignTop : styles.container}>
            ...
            {this.state.showScrollBottom && this.props.scrollToBottom
                ...
                : null}
            <ImageBackground
                source={this.props.is_landscape ? (this.props.is_pad ? require('assets/images/background/iPad_landscape.png') : require('assets/images/background/bg_landscape.png')) : (this.props.is_pad ? require('assets/images/background/iPad_portrait.png') : require('assets/images/splash_img.png'))}
