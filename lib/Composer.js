...
export default class Composer extends React.Component {
    ...
    render() {
        ...
        ]} onFocus={() => this.props.onFocus()} autoFocus={this.props.textInputAutoFocus} value={this.props.text} enablesReturnKeyAutomatically underlineColorAndroid='transparent' keyboardAppearance={this.props.keyboardAppearance} {...this.props.textInputProps}/>);
    }
}
